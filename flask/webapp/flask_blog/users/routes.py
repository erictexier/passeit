...
from flask_blog.users.forms import RequestResetForm, ResetPasswordForm
...
def user_posts(username):
    ...
    return render_template("posts/user_posts.html", title = 'user_posts', posts = posts, user = user)
